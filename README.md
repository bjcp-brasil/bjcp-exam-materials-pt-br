...
| `*-proctor-instructions-pt-br.docx` (ou `-1`/`-2`, ver nota abaixo) | Instruções para os Proctors (juízes de referência): como preencher súmulas completas e legíveis que servirão de gabarito pros corretores do exame. Uso: Proctor. |
